...
my $testFolder = $FindBin::Bin . '/qc_incorrect_readlength';
...
ok($qc->validateSequenceRun($sis,"$testFolder/quickReport.txt") == $qc->RUN_TYPE_NOT_FOUND, "QC: incorrect read length");
