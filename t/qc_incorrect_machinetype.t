...
my $testFolder = $FindBin::Bin . '/qc_incorrect_machinetype';
...
my $result = eval{$qc->validateSequenceRun($sis,"$testFolder/quickReport.txt")};
ok(!defined($result), "QC: machine type not found");
